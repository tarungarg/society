...
ActiveRecord::Schema.define(version: 20_161_123_084_316) do
  ...
  add_index 'read_marks', %w(reader_id reader_type readable_type readable_id), name: 'read_marks_reader_readable_index', unique: true, using: :btree
