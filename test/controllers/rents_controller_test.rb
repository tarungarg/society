...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { amount: @rent.amount, desc: @rent.desc, images: @rent.images, name: @rent.name }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { amount: @rent.amount, desc: @rent.desc, images: @rent.images, name: @rent.name }
    assert_redirected_to rent_path(assigns(:rent))
  end
