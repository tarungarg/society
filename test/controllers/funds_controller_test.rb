...
class FundsControllerTest < ActionController::TestCase
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post :create, fund: { amount: @fund.amount, date: @fund.date, desc: @fund.desc, title: @fund.title }
    end
  ...
  test "should update fund" do
    patch :update, id: @fund, fund: { amount: @fund.amount, date: @fund.date, desc: @fund.desc, title: @fund.title }
    assert_redirected_to fund_path(assigns(:fund))
  end
