...
class TrustsControllerTest < ActionController::TestCase
  ...
  test 'should create trust' do
    assert_difference('Trust.count') do
      post :create, trust: { amount: @trust.amount, desc: @trust.desc, from_date: @trust.from_date, titte: @trust.titte, to_date: @trust.to_date }
    end
  ...
  test 'should update trust' do
    patch :update, id: @trust, trust: { amount: @trust.amount, desc: @trust.desc, from_date: @trust.from_date, titte: @trust.titte, to_date: @trust.to_date }
    assert_redirected_to trust_path(assigns(:trust))
  end
